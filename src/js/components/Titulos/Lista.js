...
export default class Title extends React.Component {
    ...
    render() {
        return (
            <div>
                {this.filmes.results.map(function(titulo) {
                    return  <div key={titulo.id} class="panel panel-default">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-xs-5 col-md-4">
                                            <img class="poster" src={'https://image.tmdb.org/t/p/w500/' + titulo.poster_path} />
                                        </div>
                                        <div class="col-xs-7 col-md-8">
                                            <h4>{titulo.title}</h4>
                                            <span class="ano-tempo">{titulo.release_date} | 2h 6m</span>
                                            <span class="categoria">Ação, Ficção Científica, Aventura</span>

                                            <span class="sinopse">{titulo.overview}</span>
                                            <span class="rate">{titulo.vote_average}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
